<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.1//EN" "http://www.w3.org/TR/xhtml11/DTD/xhtml11.dtd"> 
    ...
    <html lang="en"> 
        <head>
          ...
          <meta name="description" content="List of Available Forms"/>
        ...
        <body style="padding-top: 70px;">        
			...
			<div id = header>
				...
				<div align="center">	
				<h1>Please choose a form below</h1>
			...
			<div align = "center" style="margin-top:50px;">
				...
				<a href="Student/progress_form.php"><button class="btn"><span>New Grad Progress Form</span></button></a>
			</div>
		</body>
